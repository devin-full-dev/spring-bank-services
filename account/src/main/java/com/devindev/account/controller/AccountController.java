...
import com.devindev.account.dto.ErrorResponseDto;
...
@Tag(
        name = "CRUD REST APIs for Accounts in Cambodia Local Bank",
        description = "CRUD REST APIs in Cambodia Local Bank to CREATE, UPDATE, FETCH AND DELETE account details"
)
@RestController
@AllArgsConstructor
...
public class AccountController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer &  Account inside Cambodia Local Bank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
